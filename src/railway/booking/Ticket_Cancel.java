...
public class Ticket_Cancel extends javax.swing.JFrame {
    ...
    String ticket_no;
    ticket_no =(String)combo_box.getSelectedItem();
      ...
      try
       {
          ...
          String c = "select train_no from ticket where ticket_no ='"+ticket_no+"';";
          ...
          String a = "Delete from ticket where ticket_no='"+ticket_no+"';";
          st.executeUpdate(a);
          
          JOptionPane.showMessageDialog(null,"Ticket with ticket number '"+ticket_no+"' .Successfully Deleted");
